Feature: Test Role creation page
  ...
  ## 106 Should display a success notification and redirect to the roles list page
  ...
  Scenario: Roundtrip about Role creation
    ...
    And  I expect current url is "{{ env.E2E_FRONT_URL }}/roles"

    When I click on ".linid-smart-filter"
    And  I set the text "E2E-ROLE-CREATION" in the HTML element '[data-cy="text-search-filter-panel_input"]'
    ...
    And  I expect the HTML element '[data-cy="item-row"]' contains "E2E Role Creation"

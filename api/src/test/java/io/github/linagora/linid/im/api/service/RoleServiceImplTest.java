...
class RoleServiceImplTest {
    ...
    void testUpdate_shouldApplyFieldsSaveAndReturnView() {
        ...
        assertEquals(record.code(), result.getCode());
        assertEquals(record.name(), result.getName());
        assertEquals(record.description(), result.getDescription());
        assertEquals(record.extraParameters(), result.getExtraParameters());

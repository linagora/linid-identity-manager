 ...
 *
 * <p>The {@code roles} are intentionally omitted: they are managed through the dedicated
 * {@code PUT /applications/{id}/roles} endpoint. The {@code script}, its {@code scriptChecksum},

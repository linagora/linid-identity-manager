...
class SupersetServiceImplTest {
    ...
    void shouldReturnOnlyMatchingEnabledRlsRules() {
        ...
        var clause = "rls_id='{{ entity.externalId }}'";
        ...
        when(jinjaService.render(clause, java.util.Map.of("entity", account)))
    ...
    void shouldBuildOrganizationalUnitRlsRule() {
        ...
        when(jinjaService.render(clause, java.util.Map.of("entity", organizationalUnit)))

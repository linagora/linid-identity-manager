Feature: Test homepage
  ...
  ## 101 Should display application title, icon, and version
    ...
    Then I expect the HTML element '[data-cy="application_version"]' contains 'Dev version'
  ...
  ## 201 Should display all home page sections
    ...
    Then I expect the HTML element '[data-cy="home-page-intro"]' contains "LinID Identity Manager"

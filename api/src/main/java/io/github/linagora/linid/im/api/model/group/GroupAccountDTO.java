...
/**
 * Data Transfer Object representing the relationship between an account and a group.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Relationship between an account and a group")
public class GroupAccountDTO {
     ...
     */
    @Schema(description = "Identifier of the group")

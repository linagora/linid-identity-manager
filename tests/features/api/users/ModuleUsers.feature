Feature: Test API Users Module
  ...
  ## 301 Should return 404 for unknown user id
  ...
  ## 502 Should return 404 when updating non-existent user
  ## 503 Should return 400 when updating user without email (skipped - linagora/linid-im-api#11)
  ## 504 Should return 400 when updating user without firstName (skipped - linagora/linid-im-api#11)
  ## 505 Should return 400 when updating user without lastName (skipped - linagora/linid-im-api#11)

  ################## Partial Update (PATCH /api/users/{id})
  ## 601 Should return 400 for invalid JSON body on PATCH
  ## 602 Should return 404 when patching non-existent user

  ################## Delete (DELETE /api/users/{id})
  ## 701 Should return 404 when deleting non-existent user
  ...
  Scenario: Should return paginated list of users
  ...
  # Note: errorKey should be error.entity.notFound but linid-im-api returns hpp.error400
  # TODO: Fix API error response format - see linagora/linid-im-api#11

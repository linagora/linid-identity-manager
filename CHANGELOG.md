...
- Defaulted `extraParameters` to an empty object on creation and kept the stored value when an update payload omits it, on accounts, organizational units, applications, groups and account relationships, instead of failing with a 500 error.
...
- Added **generic application creation page integration**, providing a reusable creation layout for application resources.
- Added **generic application edition page integration**, providing a reusable edition layout for application resources.
...
- Added **application roles management interface**:
  ...
  - Role creation, edition and deletion workflows.
- Added **application rules management interface**:
  - Editable rules list.
  - Reordering and enabling/disabling rules.
  - Rules creation, edition and deletion workflows.

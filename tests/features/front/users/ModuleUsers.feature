Feature: Test Module Users
  ...
  ## 101 Should display correct title on Users module landing page
    ...
    Then I expect the HTML element '[data-cy="module-user-title"]' contains 'Utilisateurs'

  ## 102 Should display users search panel and search field
    Then I expect the HTML element '[data-cy="advanced-search-card"]' to be visible
    Then I expect the HTML element '[data-cy="field_email"]' to be visible
    Then I expect the HTML element '[data-cy="field_firstName"]' to be visible
    Then I expect the HTML element '[data-cy="field_lastName"]' to be hidden
  ...
  ## 103 Should display users table with expected data
    Then I expect the HTML element '[data-cy="entity-table"]' exists
    And I expect the HTML element '[data-cy="user-row"]' appear 6 times on screen
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000000"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000000"]' contains "john.doe@gmail.com"
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000000"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000000"]' contains "John"
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000000"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000000"]' contains "Doe"
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000001"]' exists
    ...
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000001"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000001"]' contains "Jane"
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000001"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000001"]' contains "Roe"
  ...
  ## 201 Should redirect to user detail page when clicking View (John doe)
    ...
    Then I expect the HTML element '[data-cy="userDetailsPage"]' to be visible

  ## 202 Should display all user information on detail page (John doe)
    Then I expect the HTML element '[data-cy="user-details-card"]' to be visible
    Then I expect the HTML element '[data-cy="information-card--id"]' to be visible
    And I expect the HTML element '[data-cy="information-card--id"] [data-cy="value"]' contains "00000000-0000-0000-0000-000000000000"
    Then I expect the HTML element '[data-cy="information-card--email"]' to be visible
    And I expect the HTML element '[data-cy="information-card--email"] [data-cy="value"]' contains "john.doe@gmail.com"
    Then I expect the HTML element '[data-cy="information-card--firstName"]' to be visible
    And I expect the HTML element '[data-cy="information-card--firstName"] [data-cy="value"]' contains "John"
    Then I expect the HTML element '[data-cy="information-card--lastName"]' to be visible
    And I expect the HTML element '[data-cy="information-card--lastName"] [data-cy="value"]' contains "Doe"
    Then I expect the HTML element '[data-cy="information-card--role"]' to be visible
    And I expect the HTML element '[data-cy="information-card--role"] [data-cy="value"]' contains "admin"

  ## 203 Should display all action buttons on detail page (John doe)
    Then I expect the HTML element '[data-cy="buttons-card"]' to be visible
    Then I expect the HTML element '[data-cy="buttons-card"] [data-cy="button_cancel"]' to be visible
    Then I expect the HTML element '[data-cy="buttons-card"] [data-cy="button_cancel"]' contains "Retour à la liste des utilisateurs"
    Then I expect the HTML element '[data-cy="buttons-card"] [data-cy="button_edit"]' to be visible
    Then I expect the HTML element '[data-cy="buttons-card"] [data-cy="button_edit"]' contains "Modifier"
  ...
  ## 301 Should correctly handle pagination
    ...
    And I expect the HTML element '[data-cy="user-row"]' appear 1 times on screen
  ...
  ## 302 Should correctly handle simple search in users table
    ...
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000000"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000000"]' contains "Doe"
    Then I clear the text in the HTML element '[data-cy="field_email"]'
    When I set the text "Jane" in the HTML element '[data-cy="field_firstName"]'
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000001"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000001"]' contains "jane.roe@gmail.com"
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000001"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000001"]' contains "Jane"
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000001"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000001"]' contains "Roe"
    Then I clear the text in the HTML element '[data-cy="field_firstName"]'
    When I click on '[data-cy="advanced-search-card--toggle-button"]'
    And I set the text "Martin" in the HTML element '[data-cy="field_lastName"]'
    Then I expect the HTML element '[data-cy="item-user-cell-email_00000000-0000-0000-0000-000000000002"]' exists
    ...
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000002"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-firstName_00000000-0000-0000-0000-000000000002"]' contains "Alice"
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000002"]' exists
    Then I expect the HTML element '[data-cy="item-user-cell-lastName_00000000-0000-0000-0000-000000000002"]' contains "Martin"

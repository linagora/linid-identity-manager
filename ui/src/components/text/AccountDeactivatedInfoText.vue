...
<template>
  <div
    class="text-negative row q-gutter-x-sm account-deactivated-info-text"
    data-cy="account-deactivated-info-text"
  >
    <q-icon
      v-bind="uiProps.icon"
      class="account-deactivated-info-text--icon"
    />
    <span
      class="account-deactivated-info-text--message"
      data-cy="account-deactivated-info-text_message"
    >
      {{ t('message', { date: endDate }) }}
    </span>
  </div>
</template>

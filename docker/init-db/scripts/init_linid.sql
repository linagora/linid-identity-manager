...
$$
    ...
    BEGIN
        ...
        VALUES ('00000000-0000-4000-8000-00000000ddd1', '00000000-0000-4000-8000-00000000000f',
               ...
               ('00000000-0000-4000-8000-000123456781', '00000000-0000-4000-8000-0000000000a1',
...
-- Codes match the ^[a-zA-Z-_0-9]+$ pattern enforced by the API, so a
-- seeded group can be edited from the UI without tripping the code format
-- validation.
DO
$$
    DECLARE

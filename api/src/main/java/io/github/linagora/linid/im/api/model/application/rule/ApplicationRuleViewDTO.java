...
/**
 * Data Transfer Object representing an enriched application rule in API responses.
 *
 * <p>Exposes {@code createdBy} and {@code updatedBy} resolved to the full name of the referenced
 * account.</p>
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Enriched application rule data transfer object")
public class ApplicationRuleViewDTO {
    ...
    /**
     * Full name of the account that last updated this record.
     */

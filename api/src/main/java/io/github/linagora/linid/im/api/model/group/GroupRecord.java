 ...
 * @param label                human-readable label of the group
...
public record GroupRecord(
    ...
    @NotBlank @Schema(description = "Human-readable label of the group", example = "Developers")
    String label,
    ...
    @Email @Schema(description = "Email address of the group", example = "developers@example.com")
    String email,

...
/**
 * Data Transfer Object representing an enriched application read from the {@code applications_view}.
 *
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Application view data transfer object")

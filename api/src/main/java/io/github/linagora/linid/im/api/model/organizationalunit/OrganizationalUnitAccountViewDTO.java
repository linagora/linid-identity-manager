...
/**
 * Data Transfer Object representing an organizational unit account in API responses,
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Organizational unit account view data transfer object with enriched creator and updater"
    + " information")
public class OrganizationalUnitAccountViewDTO {
    /**
     ...
     */
    @Schema(description = "Unique identifier of the organizationalUnit",

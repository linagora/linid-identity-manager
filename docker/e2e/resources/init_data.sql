...
VALUES ('00000000-0000-0000-0000-00000000a001', 'admin',
       ...
       ('00000000-0000-0000-0000-00000000a006', 'user5', 'user5@example.com', 'user5_ln', 'user5_fn',
        ...
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001'),
       ('00000000-0000-0000-0000-00000000a007', 'user6',
        'user6@example.com', 'user6_ln', 'user6_fn',
        '{}'::jsonb, encode(digest('{}', 'sha256'), 'hex'),
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001'),
       ('00000000-0000-0000-0000-00000000a008', 'user7',
        'user7@example.com', 'user7_ln', 'user7_fn',
        '{}'::jsonb, encode(digest('{}', 'sha256'), 'hex'),
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001'),
       ('00000000-0000-0000-0000-00000000a009', 'user8',
        'user8@example.com', 'user8_ln', 'user8_fn',
        '{}'::jsonb, encode(digest('{}', 'sha256'), 'hex'),
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001'),
       ('00000000-0000-0000-0000-00000000a00a', 'user9',
        'user9@example.com', 'user9_ln', 'user9_fn',
        '{}'::jsonb, encode(digest('{}', 'sha256'), 'hex'),
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001'),
       ('00000000-0000-0000-0000-00000000a00b', 'user10',
        'user10@example.com', 'user10_ln', 'user10_fn',
        '{}'::jsonb, encode(digest('{}', 'sha256'), 'hex'),
        '00000000-0000-0000-0000-00000000a001',
        '00000000-0000-0000-0000-00000000a001')
...
$$
    ...
    BEGIN
        ...
        -- =========================================================
        -- Admin and all users in OU root

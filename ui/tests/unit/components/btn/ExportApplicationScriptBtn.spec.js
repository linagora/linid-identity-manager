...
describe('Test component: ExportApplicationScriptBtn', () => {
  ...
  describe('Test computed: hasScript', () => {
    it('should enable export button when application has no deployment date', () => {
      ...
      expect(wrapper.vm.hasScript).toBe(false);
    });

    it('should disable export button when application has deployment date', () => {
      const wrapper = shallowMount(ExportApplicationScriptBtn, {
        props: {
          uiNamespace: 'application',
          i18nScope: 'Application',
      ...
      expect(wrapper.vm.hasScript).toBe(true);
    });
  });
  ...
  describe('Test function: exportScript', () => {
    it('should export application script and notify success', async () => {
      ...
      expect(fakeLink.download).toBe('my-app');

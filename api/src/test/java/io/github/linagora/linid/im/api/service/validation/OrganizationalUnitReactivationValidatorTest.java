...
@DisplayName("Test class: OrganizationalUnitReactivationValidator")
class OrganizationalUnitReactivationValidatorTest {

    private static final UUID OU_ID = UUID.fromString("00000000-0000-0000-0000-0000000000bb");

    private OrganizationalUnitReactivationValidator validator;
    private OffsetDateTime now;

    @BeforeEach
    void setUp() {
        this.validator = new OrganizationalUnitReactivationValidator(new CommonMapper());
    ...
    void testValidate_shouldAcceptWhenSuspended() {
        ...
        OrganizationalUnitReactivationRecord record = new OrganizationalUnitReactivationRecord("comment");
    ...
    void testEnsureSuspended_shouldThrowWhenNotSuspended() {
        ...
        ApiException ex = assertThrows(ApiException.class,
            () -> validator.ensureSuspended(status, OU_ID));

        assertEquals(400, ex.getStatusCode());
        assertEquals("error.organizational.unit.status.not_suspended", ex.getError().key());
    }

...
public interface GroupRepository extends JpaRepository<Group, UUID>, JpaSpecificationExecutor<Group> {
    ...
    /**
     * Checks whether a group already uses the given code.
     *
     * @param code the functional code to look up
     * @return {@code true} if a group with this code exists
     */
    boolean existsByCode(String code);

    /**
     * Checks whether a group other than the given one already uses the given code.
     *
     * @param code the functional code to look up
     * @param id   the identifier of the group to exclude from the lookup
     * @return {@code true} if another group with this code exists
     */

...
<template>
  <div
    class="text-warning row q-gutter-x-sm organizational-unit-suspended-info-text"
    data-cy="organizational-unit-suspended-info-text"
  >
    <q-icon
      v-bind="uiProps.icon"
      class="organizational-unit-suspended-info-text--icon"
    />
    <span
      class="organizational-unit-suspended-info-text--message"
      data-cy="organizational-unit-suspended-info-text_message"
    >

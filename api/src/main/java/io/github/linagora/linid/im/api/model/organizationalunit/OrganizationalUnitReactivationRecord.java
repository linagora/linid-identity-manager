...
/**
 * Request payload for the {@code PUT /organizational-units/{id}/status/reactivation} endpoint.
 *
 ...
 */
@Schema(description = "Request payload for reactivating an organizational unit")
public record OrganizationalUnitReactivationRecord(
    @NotBlank @Schema(description = "Mandatory justification for the reactivation",
        example = "Merger completed, unit reactivated")
    String comment) {
}

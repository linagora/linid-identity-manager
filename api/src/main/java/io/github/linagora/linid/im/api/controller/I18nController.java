...
public class I18nController {
    ...
    @Operation(summary = "Get available languages", description = "Retrieves the list of available language codes (e.g., \"en\", \"fr\").")
    @ApiResponse(responseCode = "200", description = "List of available language codes", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
    ...
    @Operation(summary = "Get translation file", description = "Retrieves the translation key-value pairs for the specified language.")
    @ApiResponse(responseCode = "200", description = "Translation map for the specified language", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Map.class)))
    ...
    public ResponseEntity<Map<String, String>> getTranslationFile(
            @Parameter(description = "Language code (e.g., \"en\", \"fr\")", required = true) @PathVariable("lang") String language) {

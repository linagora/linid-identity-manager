...
/**
 * Data Transfer Object representing an organizational unit an account is attached to.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Organizational unit an account is attached to")
public class AccountOrganizationalUnitViewDTO {

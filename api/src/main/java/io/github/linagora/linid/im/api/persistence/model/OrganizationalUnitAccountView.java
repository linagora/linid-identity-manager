...
/**
 * Read-only projection of an account enriched with organizational and lifecycle metadata.
 *
 * <p>This entity is mapped to the {@code organizational_unit_accounts_view} database view
 * and exposes a denormalized representation of accounts associated with organizational units.
 *
 * <p>The view aggregates core identity information (name, email, external identifiers),
 * organizational membership, and lifecycle state derived from underlying status tables
 * and database logic.
 *
 * <p>This entity is immutable and intended strictly for read operations; persistence
 * changes must be performed through dedicated write models.
 *
 * <p>Temporal attributes such as validity and suspension periods are represented as
 * PostgreSQL range types.
 */
@Entity
@Table(name = "organizational_unit_accounts_view")
@Data
@Immutable
@SuperBuilder
@NoArgsConstructor
...
@QueryFilter
public class OrganizationalUnitAccountView extends AbstractViewEntity {

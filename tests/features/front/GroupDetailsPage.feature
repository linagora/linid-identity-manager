Feature: Test Group details page
  ...
  Scenario: Roundtrip about Group details
    ...
    When I request '{{env.E2E_API_URL}}/groups' with method 'POST' with body:
      """
      {
        "code": "grp-detail-101-parent",
        "name": "Group Detail 101 Parent"
      }
      """
    ...
    When I request '{{env.E2E_API_URL}}/groups' with method 'POST' with body:
      ...
      {
        "code": "grp-detail-101",
        "name": "Group Detail 101",
        "parentId": "{{ctx.parentGroupId}}",
        "description": "A group for the details page tests",
        "email": "grp-detail-101@example.com",
    ...
    ## 101 Should display the group details page with the profile panel and the audit section
    Given I visit the "{{ env.E2E_FRONT_URL }}/groups"
    ...
    And   I expect the HTML element '[data-cy="entity-profile-panel_title"]' contains "Group Detail 101"
    And   I expect the HTML element '[data-cy="entity-profile-panel_subtitle"]' contains "grp-detail-101"
    ...
    And   I expect the HTML element '[data-cy="entity-profile-panel"] [data-cy="information-card--parentName"] [data-cy="value"]' contains "Group Detail 101 Parent"
    And   I expect the HTML element '[data-cy="entity-profile-panel"] [data-cy="information-card--email"] [data-cy="value"]' contains "grp-detail-101@example.com"
    And   I expect the HTML element '[data-cy="entity-profile-panel"] [data-cy="information-card--description"] [data-cy="value"]' contains "A group for the details page tests"
    ...
    And  I expect the HTML element '[data-cy="form-dialog"]' contains "Modifier Group Detail 101"
    And  I expect the HTML element '[data-cy="field_code"]' to have value "grp-detail-101"
    And  I expect the HTML element '[data-cy="field_name"]' to have value "Group Detail 101"
    And  I expect the HTML element '[data-cy="field_description"]' to have value "A group for the details page tests"
    And  I expect the HTML element '[data-cy="field_email"]' to have value "grp-detail-101@example.com"
    ...
    Then I expect the HTML element '[data-cy="form-dialog"]' to be visible
    When I clear the text in the HTML element '[data-cy="field_name"]'
    And  I set the text "Group Detail 101 edited" in the HTML element '[data-cy="field_name"]'
    ...
    And  I expect the HTML element '[data-cy="entity-profile-panel_title"]' contains "Group Detail 101 edited"
    And  I expect the HTML element '[data-cy="entity-profile-panel_subtitle"]' contains "grp-detail-101"

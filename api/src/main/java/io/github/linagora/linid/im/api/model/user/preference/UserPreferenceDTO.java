...
public class UserPreferenceDTO {
     ...
     */
    @Schema(description = "Identifier of the user preference, unique per user", example = "theme")
    private String key;
     ...
     */
    @Schema(description = "Current value associated with the user preference key", example = "dark")

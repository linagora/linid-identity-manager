...
export interface ApplicationDTO {
  ...
  updatedBy: string;
  /**
   * Application creation timestamp in ISO 8601 / RFC 3339 UTC format with nanosecond precision. Example:
   * 2026-04-15T17:09:36.898493688Z.
   */
  insertDate: string;
  /**
   * Application last update timestamp in ISO 8601 / RFC 3339 UTC format with nanosecond precision. Example:
   * 2026-04-15T17:09:36.898493688Z.
   */
  updateDate: string;
}

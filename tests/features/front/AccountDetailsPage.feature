Feature: Test Account details page display
  ...
  ## 115 Lifecycle case 10 - SUSPENDED, no validity end, suspension with end
  ## 116 Lifecycle case 11 - SUSPENDED, end > 15 days
  ## 117 Lifecycle case 12 - SUSPENDED, end <= 15 days

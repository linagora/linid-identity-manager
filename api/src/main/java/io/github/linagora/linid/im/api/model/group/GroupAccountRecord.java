...
/**
 * Request payload for attaching an account to a group.
 *
 ...
 */
@Schema(description = "Request payload for attaching an account to a group")
public record GroupAccountRecord(

...
COMMENT ON TABLE groups IS 'Table storing group definitions, including optional parent group, organizational unit and application relationships, identification, and audit data.';

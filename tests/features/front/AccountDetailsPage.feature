Feature: Test Account details page display
  ...
  Scenario: Roundtrip about Account Details
    ...
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) thead th' appear 4 times on screen
    ...
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) thead th:nth-child(3)' contains "Email"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) thead th:nth-child(4)' contains "Description"
    # Support belongs to user4 only, and admin is in All Staff: exactly two rows here means the
    # endpoint kept the account filter instead of returning every group
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr' appear 2 times on screen
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(1) td:nth-child(1)' contains "all-staff"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(1) td:nth-child(2)' contains "All Staff"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(1) td:nth-child(3)' contains "all-staff@example.com"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(1) td:nth-child(4)' contains "Every account of the organization."
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(2) td:nth-child(1)' contains "developers"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(2) td:nth-child(2)' contains "Developers"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(2) td:nth-child(3)' contains "developers@example.com"
    And I expect the HTML element '[data-cy="generic-entity-table"]:eq(1) tbody tr:nth-child(2) td:nth-child(4)' contains "Software development team."

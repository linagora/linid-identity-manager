Feature: Test Organizational Unit creation page
  ...
  ## 201 Should display title, form fields and action buttons
  ## 202 Parent organizational unit should be displayed with the resolved root name
  ## 203 Type select should expose the static types from the configuration
  ## 204 Submitting an empty form should display required validation messages
  ## 205 Submitting a valid form should create the organizational unit
  ## 206 Should display a success notification after creation
  ## 207 Visiting the page without a parent should redirect to the home page
  ## 208 Remove the created organizational unit
  ...
  Scenario: Roundtrip about Organizational Unit creation
    ...
    ## 208 Remove the created organizational unit (looked up by name)
